...
namespace ResourceSlimes.Content.Items.Gel
{
	public class MerchantGel : ModItem
	{
		...
		public override void SetStaticDefaults() {
			Tooltip.SetDefault("Don't ask where they found these items...\nCan be converted into various building items sold by a Travelling Merchant at a Solidifier."); // The (English) text shown below your item's name
