...
namespace ResourceSlimes.Content.Enemies.MaterialSlime
{
    public class TerracottaSlime : ModNPC
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Terracotta Slime");
        ...
        public override void ModifyNPCLoot(NPCLoot npcLoot) {
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<Content.Items.Gel.MaterialGel>()));
